#
#  Be sure to run `pod spec lint CapermintGamingSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A SDK for different types of Games."
  ...
  # Or just: spec.author    = "Khushali Nimje"
  # spec.authors            = { "Khushali Nimje" => "khushali@caperminttechnologies.com" }
  # spec.social_media_url   = "https://twitter.com/Khushali Nimje"
